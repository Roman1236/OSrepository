...
public class Time_Priority extends JFrame {
    protected int value[];
    protected Form form;
    protected String x,y;
    public Time_Priority(Form form, int[] value, String x, String y) {
        super("Час/Пріоритет");
        this.form=form;
        this.x=x;
        this.y=y;
    ...
    public void paint(Graphics g) {
        ...
        g.drawString(String.valueOf(value[form.getPrMin()]),58, 578-value[form.getPrMin()]);
